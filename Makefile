...
BINARY_NAME:=swag
PACKAGES:=$(shell $(GOLIST) github.com/Constructor-io/swag/v2 github.com/Constructor-io/swag/v2/cmd/swag github.com/Constructor-io/swag/v2/gen github.com/Constructor-io/swag/v2/format)
...
.PHONY: deps
deps:
	$(GOGET) github.com/Constructor-io/cli
